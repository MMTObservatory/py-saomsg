Python utilities for interacting with SAO's MSG network protocol
----------------------------------------------------------------
...
We love contributions! py-saomsg is open source,
...
py-saomsg based on its use in the README file for the
